  ...
  <div className={styles.container}>
    <div className={styles.wrapper}>
      ...
      <div className={styles.btn_container}>
        <button className={styles.gary} onClick={clear}>
          AC
        </button>
        <button className={styles.gary} onClick={changeSign}>
          +/-
        </button>
        <button className={styles.gary} onClick={percent}>
          %
        </button>
